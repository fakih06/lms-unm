...
class vdetailTugas extends StatefulWidget {
  const vdetailTugas({Key? key}) : super(key: key);

  @override
  _vdetailTugasState createState() => _vdetailTugasState();
}

class _vdetailTugasState extends State<vdetailTugas> {
  @override
            ...
            children: [
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const vkumpulTugas()));
                  },
                ),
              ),
            ],
